...
export const mensPerfumePage = defineType({
  name: 'mensPerfumePage',
  title: "Men's Perfume Page",
  type: 'document',
  fields: [
    defineField({
      name: 'title',
      title: 'Page Title',
      type: 'string',
      initialValue: "Men's Perfume Page",
    ...
    defineField({
      ...
      description: 'Select perfumes, main perfumes, and collections to display on the men\'s perfume page',
  ...
  preview: {
    ...
    prepare(selection) {
      ...
      return {
        title: title || "Men's Perfume Page",
