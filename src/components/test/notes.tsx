  ...
  const cardsData = [
    {
      ...
      title: "Performance",
      description:
        "Lightning-fast loading speeds and optimized performance for the best user experience.",
    },
    {
      id: 2,
      icon: "🎨",
      title: "Design",
      description:
        "Beautiful, modern designs that captivate users and drive engagement.",
    },
    {
      id: 3,
      icon: "🚀",
    ...
    },
    {
      ...
      title: "Security",
      description:
        "Enterprise-grade security features ensuring your data stays protected at all times.",
    },
  ];
